...
async function login(req, res) {
    ...
    const token = jwt.sign({userId: req.data.id, currentUser: req.data.name, location: req.data.location, verified: req.data.verified}, process.env.JWT_SECRET, {expiresIn: '5h'})
